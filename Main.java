...
public class Main extends JFrame {
    ...
    public Main() {
        setTitle("TP2 - Mi Sistema de Productos"); // Establece el título de la ventana.
        setSize(400, 400); // Define el ancho y alto de la ventana.
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Cierra la aplicación al cerrar la ventana.*/
        setLocationRelativeTo(null); // Centra la ventana en la pantalla.
        getContentPane().setBackground(new java.awt.Color(240, 248, 255)); // Color de fondo azul clarito.
        ...
        btnRegistrar = new JButton("Guardar el producto"); // Botón para guardar el producto.
